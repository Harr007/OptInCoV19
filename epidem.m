...
function [y,dy] = epidem(dt, x, beta,u,v, gamma_i, gamma_d, gamma_a, ksi_i, ksi_d, mu,mu_h, H_th, zeta, psi, psi_hat)
    ...
    dy(5,1) = gamma_i*x(2,1) +  gamma_d*x(3,1) + g1 + psi_hat*x(5,1); %Recovered State
